...
export default function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-5 left-5 right-5 z-50 safe-area-pb">
      <div className={`grid ${gridColsClass} h-16 bg-bg/90 backdrop-blur-xl border border-border rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.12)] overflow-hidden`}>
        {navItems.map((item) => {
          const isActive =
            item.to === '/'
              ? location.pathname === '/'
